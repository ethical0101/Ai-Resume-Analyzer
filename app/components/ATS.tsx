...
const ATS: React.FC<ATSProps> = ({ score, suggestions }) => {
  ...
  return (
    <div
      className={`w-full rounded-2xl shadow-md bg-gradient-to-br ${gradientFrom} to-white`}
    >
      {/* Top section */}
      ...
      <div className="px-5 pb-5 space-y-3">
        ...
        <p className="text-sm text-gray-500">
          These insights reflect how an Applicant Tracking System (ATS) might
          interpret your resume. Use the tips below to improve parsing accuracy
        ...
        <p className="text-sm text-gray-600 pt-1">
          Keep iterating—small improvements can make a big difference in ATS
