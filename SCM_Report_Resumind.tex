...
\begin{titlepage}
    ...
    Kaswibhatala Navyatha Simha (Reg No: 23MIS0242)
    \par}
...
\begin{figure}[H]
    ...
    \centering
    \textbf{Architecture Diagram Placeholder}\\[0.3cm]
    Include a block diagram showing:\\
    User Browser $\rightarrow$ React+Vite Frontend $\rightarrow$ Puter.js Services\\
    (Auth, FS, KV, AI) $\rightarrow$ Result Rendering and Storage.
    }}
...
\begin{figure}[H]
    ...
    \centering
    \textbf{Workflow Diagram Placeholder}\\[0.2cm]
    Developer $\rightarrow$ GitHub Commit/Push $\rightarrow$ TeamCity Build\\
    $\rightarrow$ Vercel Deployment $\rightarrow$ End User Access
    }}
